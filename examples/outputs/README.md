...
- **`sample_scenarios/`** - Selected scenarios showing Human+'s performance
  ...
  - `scenario_2_wins.json` - Example of strong performance
...
```json
{
  "model": "Human+-Claude-Deep",
  "elo_normalized": 1633.26,
  "rank": "Top tier performance",
  "win_rate": "High across scenarios"
}
```

**Key Achievement:** 1633 ELO normalized, demonstrating measurable emotional intelligence through theoretical grounding in Consciousness + Conflict Theory.
...
- ✅ Incisiveness (cutting to core dynamics)
- ✅ Reading between lines (detecting unspoken patterns)
- ✅ Theory of mind (modeling multiple perspectives)
- ✅ Depth of insight (penetrating psychological layers)
- ✅ Causal attribution (explaining underlying motivations)
...
- ⚠️ Can be too analytical/academic
- ⚠️ Occasionally overinterprets
- ⚠️ Sacrifices warmth for precision
...
[See full scenario details →](sample_scenarios/scenario_404_wins.json)
...
[See full scenario details →](sample_scenarios/scenario_2_wins.json)
